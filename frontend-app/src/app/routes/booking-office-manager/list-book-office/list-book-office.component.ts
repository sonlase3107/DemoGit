...
@Component({
  selector: 'app-list-book-office',
  templateUrl: './list-book-office.component.html',
  styleUrls: ['./list-book-office.component.css']
})
export class ListBookOfficeComponent implements OnInit {
